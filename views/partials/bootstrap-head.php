...
?>
  ...
  ?>
  <link rel="icon" type="image/x-icon" href="/redmine/favicon.ico?v=<?= (int)$faviconIcoVersion ?>" data-app-favicon>
  <link rel="shortcut icon" type="image/x-icon" href="/redmine/favicon.ico?v=<?= (int)$faviconIcoVersion ?>" data-app-favicon>
  <link rel="icon" type="image/svg+xml" href="/redmine/assets/favicon.svg?v=<?= (int)$faviconSvgVersion ?>" data-app-favicon>
  <script>
